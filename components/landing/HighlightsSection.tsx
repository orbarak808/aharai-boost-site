          ...
          {highlights.map((highlight) => {
            ...
            return (
              ...
              >
                ...
                <p className="min-h-[110px] text-sm sm:text-base text-gray-300 group-hover:text-gray-100 leading-relaxed transition-colors flex items-start justify-center">
